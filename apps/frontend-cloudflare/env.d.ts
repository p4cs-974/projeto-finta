/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 391af4680725ec18f1077bec8d4930e8)
// Runtime types generated with workerd@1.20260301.1 2025-10-08 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./.open-next/worker");
  }
  interface Env {
    FINTA_RELEASES_BUCKET: R2Bucket;
    ASSETS: Fetcher;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "BACKEND_API_BASE_URL">
  > {}
}
