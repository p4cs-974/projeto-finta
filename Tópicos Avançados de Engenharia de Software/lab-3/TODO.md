...
## Objetivo
Modelar o sistema utilizando a abordagem de Cheesman & Daniels, estruturando a arquitetura em componentes, com interfaces, contratos e dependências bem definidas.

## Atividades

### Entrega 1 (25/02/2026)
- [x] Elaborar o diagrama de casos de uso e detalhar o fluxo de no mínimo 3 casos de uso principais.
- [x] Definir os serviços oferecidos externamente pelo sistema (interfaces do sistema).
